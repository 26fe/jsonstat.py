...
def test_to_table_eurostat_one_dim():
    ...
    json_pathname = os.path.join(fixture_dir, "www.ec.europa.eu_eurostat", "eurostat-name_gpd_c-geo_IT.json")
    ...
    to_table_pathname = os.path.join(fixture_dir, "output_from_nodejs", "eurostat-name_gpd_c-geo_IT-to_table.csv")
...
def test_to_table_oecd_canada():
    ...
    # read generate table by jsonstat js module
    to_table_pathname = os.path.join(fixture_dir, "output_from_nodejs", "oecd-canada-to_table.csv")
...
def test_to_table_ssb_no():
    ...
    # read generate table by jsonstat js module
    to_table_pathname = os.path.join(fixture_dir, "output_from_nodejs", "29843-to_table.csv")
